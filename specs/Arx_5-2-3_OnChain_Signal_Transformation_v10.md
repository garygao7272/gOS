...
**Artifact ID:** Arx_5-2-3 (v10)
**Last Updated:** 2026-03-31
**Status:** Active
**Supersedes:** Arx_5-2-3_OnChain_Signal_Transformation_v9.md (retained as editorial reference)
...
**His workflow on Radar:** Pre-Trade — "What's the market doing? Where's the edge?" → Radar Discover mode (Story 7).
