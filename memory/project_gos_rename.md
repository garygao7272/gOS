...
description: Renamed the command system from "god/writ" (38 commands) to "gOS" (8 verbs + 2 utilities) on 2026-03-21, inspired by gstack and GSD
type: project
---
...
**New system:** "gOS" (Gary's OS) with 8 verbs + 2 utilities, soul file gOS.md, entry command /gos
...
The 8 verbs: /gos, /think, /design, /simulate, /build, /review, /ship, /evolve
Utilities: /aside, /claw, /checkpoint
