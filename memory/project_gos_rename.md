...
description: Renamed the command system from "god/writ" (38 commands) to "gOS" (7 verbs + 1 utility) on 2026-03-21, inspired by gstack and GSD
type: project
---
...
**New system:** "gOS" (Gary's OS) with 7 verbs + 1 utility, soul file gOS.md, entry command /gos
...
The 7 verbs: /gos, /think, /design, /simulate, /build, /review, /ship, /evolve
Utility: /aside
