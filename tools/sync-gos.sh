...
classify_changes() {
  ...
  while IFS= read -r line; do
    ...
    case "$path" in
      ...
      commands/*|agents/*|hooks/*|.claude/hooks/*|rules/*|skills/*|tools/*|output-styles/*|evals/*|claws/*|bootstrap/*|docs/*|templates/*|settings/settings.json|install.sh|CLAUDE.md|README.md|invariants.md|gos-plugin-build/*|tests/hooks/*|.gitignore)
        FRAMEWORK_FILES+=("$path") ;;
