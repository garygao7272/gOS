...
Before generating, read `${CLAUDE_SKILL_DIR}/STYLE_PRESETS.md` for the viewport-safe CSS base, density limits, preset catalog, and CSS gotchas.
...
Use the preset guide in `${CLAUDE_SKILL_DIR}/STYLE_PRESETS.md` when mapping mood to style.
...
- a viewport-safe CSS base from `${CLAUDE_SKILL_DIR}/STYLE_PRESETS.md`
...
Use the density limits and mandatory CSS block in `${CLAUDE_SKILL_DIR}/STYLE_PRESETS.md`.
